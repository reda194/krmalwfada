      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row justify-between items-start gap-16 mb-24">
          ...
          <div className="w-full lg:w-auto bg-white/5 p-10 rounded-[2.5rem] border border-white/10 shadow-[0_30px_60px_rgba(0,0,0,0.3)] backdrop-blur-xl relative overflow-hidden">
            ...
            <h4 className="text-2xl font-bold mb-8 flex items-center gap-3 relative z-10">
              <span className="w-2 h-8 bg-gold rounded-full inline-block shadow-[0_0_10px_rgba(212,175,55,0.8)]"></span>
              اشترك في نشرتنا البريدية
            </h4>
            
            <div className="flex w-full max-w-md relative group z-10">
              ...
              <input 
                ...
                dir="rtl"
              />
              <button className="relative bg-gradient-to-l from-gold to-yellow-500 text-[#021A11] px-8 py-5 font-black text-xl rounded-l-2xl hover:shadow-[0_0_20px_rgba(212,175,55,0.5)] transition-all shrink-0">
                اشتراك
              </button>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16 border-t border-white/10 pt-16">
          <div>
            <h5 className="font-bold text-gold mb-8 text-xl">عن كرم الوفادة</h5>
            <ul className="space-y-5 text-gray-400 font-light text-lg">
              <li><a href="#" className="hover:text-white hover:text-gold hover:-translate-x-2 inline-block transition-transform duration-300">قصتنا</a></li>
              <li><a href="#" className="hover:text-white hover:text-gold hover:-translate-x-2 inline-block transition-transform duration-300">رسالتنا</a></li>
              <li><a href="#" className="hover:text-white hover:text-gold hover:-translate-x-2 inline-block transition-transform duration-300">مجلس الإدارة</a></li>
              <li><a href="#" className="hover:text-white hover:text-gold hover:-translate-x-2 inline-block transition-transform duration-300">الشركاء الاستراتيجيون</a></li>
            </ul>
          </div>
          <div>
            <h5 className="font-bold text-gold mb-8 text-xl">مشاريعنا</h5>
            <ul className="space-y-5 text-gray-400 font-light text-lg">
              <li><a href="#" className="hover:text-white hover:text-gold hover:-translate-x-2 inline-block transition-transform duration-300">سقيا ماء زمزم</a></li>
              <li><a href="#" className="hover:text-white hover:text-gold hover:-translate-x-2 inline-block transition-transform duration-300">إطعام ضيف الرحمن</a></li>
              <li><a href="#" className="hover:text-white hover:text-gold hover:-translate-x-2 inline-block transition-transform duration-300">الإرشاد الميداني</a></li>
              <li><a href="#" className="hover:text-white hover:text-gold hover:-translate-x-2 inline-block transition-transform duration-300">برامج الضيافة والإسكان</a></li>
            </ul>
          </div>
          <div>
            <h5 className="font-bold text-gold mb-8 text-xl">شارك معنا</h5>
            <ul className="space-y-5 text-gray-400 font-light text-lg">
              <li><a href="#" className="hover:text-white hover:text-gold hover:-translate-x-2 inline-block transition-transform duration-300">تطوع الآن</a></li>
              <li><a href="#" className="hover:text-white hover:text-gold hover:-translate-x-2 inline-block transition-transform duration-300">الرعاية والشراكات</a></li>
              <li><a href="#" className="hover:text-white hover:text-gold hover:-translate-x-2 inline-block transition-transform duration-300">سفراء العطاء</a></li>
              <li><a href="#" className="hover:text-white hover:text-gold hover:-translate-x-2 inline-block transition-transform duration-300">حسابات التبرع المباشر</a></li>
            </ul>
          </div>
          <div>
            <h5 className="font-bold text-gold mb-8 text-xl">تواصل معنا</h5>
            <ul className="space-y-6 text-gray-300 font-light text-lg">
              <li className="flex gap-4 items-start hover:text-gold transition-colors cursor-pointer group">
                ...
                <span className="mt-2 leading-relaxed">مكة المكرمة، المنطقة المركزية،<br/>المملكة العربية السعودية</span>
              </li>
              <li className="flex gap-4 items-center hover:text-gold transition-colors cursor-pointer group">
                <div className="bg-white/5 p-3 rounded-xl border border-white/5 shadow-inner group-hover:bg-gold/10 group-hover:border-gold/30 transition-all">
                  <Phone className="w-5 h-5 text-gold" />
                </div> 
                <span dir="ltr" className="font-medium tracking-wider">+966 920 000 000</span>
              </li>
              <li className="flex gap-4 items-center hover:text-gold transition-colors cursor-pointer group">
                <div className="bg-white/5 p-3 rounded-xl border border-white/5 shadow-inner group-hover:bg-gold/10 group-hover:border-gold/30 transition-all">
                  <Mail className="w-5 h-5 text-gold" />
                </div> 
                <span className="font-medium">info@krmalwfada.sa</span>
              </li>
            </ul>
          </div>
        </div>
